...
<ul class="breadcrumb">
    <li>
        <i class="icon-home"></i>
        <a href="{{URL::to('/dashbord')}}">Dashbord</a>
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header" data-original-title>
            <h2><i class="halflings-icon edit"></i><span class="break"></span>Add Poduct</h2>
            <div class="box-icon">
            ...
            <form class="form-horizontal" action="{{url('/save-product')}}" method="post" enctype="multipart/form-data">
              ...
              <fieldset>
                ...
                <div class="control-group hidden-phone">
                  <label class="control-label" for="textarea2">Poduct Short Description</label>
                  <div class="controls">
                    <textarea class="cleditor" name="product_short_description" rows="3" required=""></textarea>
                  </div>
                </div>
                <div class="control-group hidden-phone">
                    <label class="control-label" for="textarea2">Poduct Long Description</label>
                    <div class="controls">
                ...
                <div class="control-group hidden-phone">
                    ...
                    <div class="controls">
                      <input type="checkbox" name="publication_statuts" value="1">
                    </div>
                  </div>
